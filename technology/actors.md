...
![Samenhang tussen systeemactoren](../.gitbook/assets/technology/actorcoherence.svg)
...
Een gegevensautoriteit is een rol van een organisatie of persoon. Het is een erkenning dat geautoriseerd is voor het uitgeven van een verklaring, bijvoorbeeld een identificatie of een kwalificatie.
...
Een gegevensregisseur kan de volgende verantwoordelijk invullen:
...
Een gezondheidsregisseur kan de volgende verantwoordelijk invullen:

- **Regie op gezondheid** overeenkomstig de functies van een persoonlijke gezondheidsomgeving.

## Ledenadministratie

Een ledenadministratie registreert de leden in het ecosysteem. het zijn zowel de deelnemers aan het ecosysteem als de actoren die een gemeenschappelijke voorziening leveren voor de werking van het ecosysteem

Een ledenadministratie heeft de volgende verantwoordelijk:
...
Een operationeel beheerder heeft minimaal de volgende verantwoordelijk:

- Een **gemeenschappelijke helpdesk**.

## Stelselbeheerder

De stelselbeheerder is een rol binnen de besturing van het informatiestelsel. Naast haar rol in het stelselmanagement heeft de stelselbeheerde ook een rol in het vertrouwen van het ecosysteem.
